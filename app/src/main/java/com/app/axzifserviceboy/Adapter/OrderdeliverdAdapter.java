...
public class OrderdeliverdAdapter  extends  RecyclerView.Adapter<OrderdeliverdAdapter.ViewHolder>
{
    private Context context;
    private List<Datum> list = new ArrayList<>();
    double lat, longi;
    public OrderdeliverdAdapter(Context context, List<Datum> list,double lat,double longi)
    {
    ...
    @NonNull
    @Override
    public OrderdeliverdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.deliverycompleted, parent, false);
        return  new ViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderdeliverdAdapter.ViewHolder holder, int position)
    {
