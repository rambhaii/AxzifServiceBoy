...
import com.app.axzifserviceboy.Adapter.OrderdeliverdAdapter;
...
public class CompletedServices extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        texttoolbar.setText("Completed  Orders List");
    ...
    private void dataParse(String from ,Double lat,double longi)
    {
        ...
        OrderdeliverdAdapter adapter=new OrderdeliverdAdapter(this,data,lat,longi);
